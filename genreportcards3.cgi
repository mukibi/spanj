...
<em>$err_str</em>
				...
				#print "X-Debug: executed SELECT...WHERE $start_yr_where_clause with values: " . join(", ", keys %possib_start_yrs) ."\r\n";
				...
				print "X-Debug: working with the following rolls: " . join(", ", keys %stud_rolls). "\r\n";
				if ($matched_rolls) {
					my @where_clause_bts = ();
...
<img src="/images/letterhead.png" alt="" href="/images/letterhead.png">
<br>
<h3>$current_exam</h3>
</div>
<br>
						...
						if ($pic) {
							...
							if ($pdf_mode) {
								my $image_obj = undef;
								my $image_n = qq!${doc_root}$images{$stud_6}!;
								...
								$res .=
qq!
<img src="$images{$stud_6}" height="200" width="170" style="float: left; margin: 4px">
